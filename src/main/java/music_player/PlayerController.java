...
public class PlayerController {
    ...
    private PreviewFileController paneController;
    ...
    public PlayerController(XmlSequence sequence, PreviewFileController pane) throws InvalidMidiDataException, MidiUnavailableException, ParsingException, ParserConfigurationException, IOException {
        this(sequence);
//		trans = sequencer.getTransmitter();
//		trans.setReceiver(new customReceiver());
//        this.paneController = pane;
    }


    // only for highlighting the notes
//    private class customReceiver implements Receiver {
//        @Override
//        public void send(MidiMessage message, long timeStamp) {
//            // get the message when note is played
...
//    }
    ...
    private void initialize() throws IOException {
        ...
        mediaSliderAnimation = new Timeline(new KeyFrame(Duration.seconds(0.1), new EventHandler<ActionEvent>() {
            @Override
    ...
    public boolean saveSong() {
        ...
        fileChooser.getExtensionFilters().addAll(new ExtensionFilter("MIDI file", "*.midi"));
